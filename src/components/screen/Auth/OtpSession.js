        ...
        return (
            <View style={styles.wrap}>
                ...
                <Content style={{ paddingHorizontal: 40, marginTop: 60 }}>
                    ...
                    <TouchableOpacity style={{ height: 44, backgroundColor: '#57DBE9', marginTop: 20, borderRadius: 24, justifyContent: 'center', alignItems: 'center' }}><Text style={{ color: 'white', fontSize: 20 }}>Check</Text></TouchableOpacity>
